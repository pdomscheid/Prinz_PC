 ...
 *
 */
public class MenuScreen extends Games implements Screen{
	...
	public MenuScreen(PrinceGame game) {
		super(game);
		this.game = game;
	...
	public void render(float delta) {
		...
		float positionXStartGame = PrinceGame.WIDTH / half - layout.width / half;
		float positionYStartGame = PrinceGame.HEIGHT / half + PrinceGame.HEIGHT / 4;
		...
		float positionXDescription = PrinceGame.WIDTH / half - layout.width / half;
		float positionYDescription = PrinceGame.HEIGHT / half;
		...
		float positionXCloseGame = PrinceGame.WIDTH / half - layout.width / half;
		float positionYCloseGame = PrinceGame.HEIGHT / half - PrinceGame.HEIGHT / 4;
